...
{
    public partial class DrivingLicensePageViewModel : BaseViewModel
    {
        ...
        public DrivingLicensePageViewModel(INavigation navigation)
        {
            _navigation = navigation;
            Title = "Driving License Details";
            
            // Initialize properties
            frontImage = ImageSource.FromFile("license_front_placeholder.png");
            backImage = ImageSource.FromFile("license_back_placeholder.png");
        ...
        private async Task SubmitAsync()
        {
            ...
            if (!IsFrontUploaded)
            {
                await Application.Current.MainPage.DisplayAlert("Error", "Please upload front side of Driving License", "OK");
                return;
            }

            if (!IsBackUploaded)
            {
                await Application.Current.MainPage.DisplayAlert("Error", "Please upload back side of Driving License", "OK");
                return;
            }
